...
def add_lumi(luminumber, year):
    ...
    lumi.SetTextFont (   42 )
    lumi.AddText(year + ", " + str(luminumber) + " fb^{-1} (13TeV)")
    return lumi
...
class DisplayManager(object):
    ...
    def __init__(self, name, ratio, lumi, year, xmin=0.42, ymin=0.6, signal2show = []):
...
#                h.GetXaxis().SetLabelSize(0)
        ...
        l1=add_lumi(self.lumi, self.year)
        l1.Draw("same")
        l2=add_CMS()
        l2.Draw("same")
        l3=add_Preliminary()
