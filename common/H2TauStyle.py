...
histPref['jpsi_tau'] = {'style':s_taucol_3, 'layer':4, 'legend':'Bc#rightarrowJ/#psi#tau_{h}#nu'}
...
histPref['jpsi_hc'] = {'style':s_jpsi_3, 'layer':3, 'legend':'Bc#rightarrowJ/#psi D(*)^{+}_{s}'}
...
histPref['bc_others*'] = {'style':s_others, 'layer':2, 'legend':'Bc#rightarrow others'}
...
histPref['fakes'] = {'style':sHTT_DYJets, 'layer':12, 'legend':'DD J/#psi X bkg'}
