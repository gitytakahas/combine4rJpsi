...
histPref['jpsi_tau'] = {'style':sHTT_TTJets_v2, 'layer':4, 'legend':'Bc#rightarrowJ/#psi#tau_{h}#nu'}
...
histPref['jpsi_hc'] = {'style':sHTT_DYJets, 'layer':3, 'legend':'Bc#rightarrowh_{c}#mu#nu'}
...
histPref['bc_others*'] = {'style':sHTT_WJets, 'layer':2, 'legend':'Bc#rightarrow others'}
...
histPref['fakes'] = {'style':sHTT_QCD, 'layer':12, 'legend':'Inclusive J/#psi'}
