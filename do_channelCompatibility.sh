...
option="--setRobustFitAlgo=Minuit2 --setRobustFitStrategy=0 --setRobustFitTolerance=0.2 --X-rtd MINIMIZER_analytic --cminFallbackAlgo Minuit2,0:0.5 --cminFallbackAlgo Minuit2,0:1.0 --cminPreScan --cminPreFit 1 --rMin -7 --rMax 7"
...
combine -M ChannelCompatibilityCheck --robustFit 1 ${option} ${workspace} ${toy} -m 125 --group=taulep_ch --group=tauhad
